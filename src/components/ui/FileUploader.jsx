  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {!preview ? (
        <label
          htmlFor="file-input"
          className={`flex-1 min-h-[180px] border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-blue-400 hover:bg-blue-50/50 transition-colors ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
        >
